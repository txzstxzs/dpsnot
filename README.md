...
1 DPS-not     It is used to reproduce results about DPS-not. It also includes the baselin Diffusion-TS.

2 MAP-not     It is used to reproduce figure 2 and can be used to reproduce results about MAP-not.

3 VI-not        It is used to reproduce results about DPS-not.

4 baselines      It is used to reproduce results about the baselines CSDI, SAITS, DLinear and TimeMixer.
